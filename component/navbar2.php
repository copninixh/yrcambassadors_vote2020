<nav class="navbar navbar-inverse navbar-expand-lg bg-light fixed-top " style="border-bottom:5px solid #e91e63" role="navigation-demo">
            <div class="container">
              ...
              <div class="navbar-translate">
                <a class="navbar-brand text-rose" href="vote_yrcambassador.php"><i class="fas fa-vote-yea"></i> YRC Ambassadors 2020 </a>
              ...
              <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto" >
                  <li class="nav-item">
                    <a href="vote_yrcambassador.php" class="nav-link" style="font-size: 15px;">
